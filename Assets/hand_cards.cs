...
public class hand_cards : MonoBehaviour
{
    ...
    void Play_Card0()
    {
        int level = card_setting.cards_lv[0];
        int quality = card_setting.cards_ql[0];
    ...
    void Play_Card1()
    {
        int level = card_setting.cards_lv[1];
        int quality = card_setting.cards_ql[1];
    ...
    void Play_Card2()
    {
        int level = card_setting.cards_lv[2];
        int quality = card_setting.cards_ql[2];
    ...
    void Play_Card3()
    {
        int level = card_setting.cards_lv[3];
        int quality = card_setting.cards_ql[3];
    ...
    void Play_Card4()
    {
        int level = card_setting.cards_lv[4];
        int quality = card_setting.cards_ql[4];
    ...
    void Play_Card5()
    {
        int level = card_setting.cards_lv[5];
        int quality = card_setting.cards_ql[5];
